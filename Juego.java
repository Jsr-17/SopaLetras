...
public class Juego extends Tablero {
    ...
    String sopaLetrasDificil[] = { "ROJO", "POLLO", "ROMERO", "ALOE", "ARMA", "CHATEAR", "PATRON", "SAL", "OSO", "DADO",
            "COMIDA", "MES", "CERDO", "OJO", "AMOR", "TACHO", "LAS", "OTRO" };

    public void compruebaGanador() {
        boolean vacio = true;

        for (int i = 0; i < palabrasEncontradas.length; i++) {
            if (palabrasEncontradas[i] == null) {
                vacio = false;
            }
        }
        if (vacio) {
    ...
    public void pintaTablero() {
        ...
        if (dificil) {
            ...
            for (int i = 0; i < sopaLetrasNormal.length; i++) {
                System.out.print("        "+sopaLetrasNormal[i]+" ");
            }
            System.out.println("");
            System.out.println("");
            for (int i = 0; i < 4; i++) {
        ...
        if (dificil) {
            ...
            for (int i = 0; i < sopaLetrasDificil.length; i++) {
                if (letra.equals(sopaLetrasDificil[i])) {
                    ...
                    System.out.println("\n\n\nHas encontrado la palabra " + letra + "\n\n\n");
                    this.letra = "";
            ...
            for (int j = 0; j < palabrasEncontradas.length; j++) {
                if (letra.equals(palabrasEncontradas[j])) {
                    System.out.println("\n\n\nHas encontrado ya esa palabra\n\n\n");
                    this.letra = "";
                }
            }
    ...
    public void pedirLetra() {
        pintaTablero();
        System.out.println(
                "Para escoger la palabra que has reconocido elige las posiciones x e y respectivamente de cada letra saldrá la palabra que se va formando por ejemplo 1,2\nEn el caso de querer borrar la palabra escribe Borrar");
        String texto = scanner.nextLine();
        if (texto.equalsIgnoreCase("borrar") || texto.equalsIgnoreCase("borar") || texto.equalsIgnoreCase("borra")
                || texto.equalsIgnoreCase("vorrar") || texto.equalsIgnoreCase("vora")) {
            this.letra = "";
            return;
        }
    ...
    public void asignaValores(int dificultad) {
        if (dificultad == 0) {
            ...
            for (int i = 0; i < 8; i++) {
                for (int j = 0; j < 10; j++) {
                    if (i == 0 && j == 0 || i == 0 && j == 6 || i == 0 && j == 8 || i == 1 && j == 4 ||
                            i == 1 && j == 7 || i == 1 && j == 9 || i == 2 && j == 0 || i == 2 && j == 3 ||
                            i == 2 && j == 7 || i == 3 && j == 1 || i == 3 && j == 2 || i == 3 && j == 3 ||
                            i == 3 && j == 7 || i == 4 && j == 9 || i == 5 && j == 3 || i == 6 && j == 0 ||
                            i == 7 && j == 4) {
                        tableroJuego[i][j] = 'O';
                    } else if (i == 0 && j == 3 || i == 2 && j == 5 || i == 4 && j == 1 || i == 6 && j == 5
                            || i == 3 && j == 8) {
                        tableroJuego[i][j] = 'E';
                    } else if (i == 0 && j == 1 || i == 2 && j == 1 || i == 4 && j == 4) {
                        tableroJuego[i][j] = 'D';
                    } else if (i == 0 && j == 2 || i == 0 && j == 5 || i == 2 && j == 2 || i == 2 && j == 6 ||
                            i == 4 && j == 2 || i == 4 && j == 3 || i == 5 && j == 7 || i == 6 && j == 7 ||
                            i == 7 && j == 3 || i == 6 && j == 8) {
                        tableroJuego[i][j] = 'R';
                    } else if (i == 0 && j == 4 || i == 6 && j == 1) {
                        tableroJuego[i][j] = 'C';
                    } else if (i == 0 && j == 9 || i == 3 && j == 0 || i == 4 && j == 5 || i == 4 && j == 6 ||
                            i == 5 && j == 2 || i == 6 && j == 7) {
                        tableroJuego[i][j] = 'X';
                    } else if (i == 0 && j == 7) {
                        tableroJuego[i][j] = 'J';
                    } else if (i == 0 && j == 9 || i == 3 && j == 0 || i == 4 && j == 6 || i == 4 && j == 7 ||
                            i == 5 && j == 2 || i == 6 && j == 8) {
                        tableroJuego[i][j] = 'X';
                    } else if (i == 1 && j == 0 || i == 3 && j == 9 || i == 4 && j == 8 || i == 7 && j == 6) {
                        tableroJuego[i][j] = 'S';
                    } else if (i == 1 && j == 3 || i == 4 && j == 0 || i == 7 && j == 0) {
                        tableroJuego[i][j] = 'P';
                    } else if (i == 1 && j == 1 || i == 1 && j == 2 || i == 2 && j == 9 || i == 3 && j == 5 ||
                            i == 5 && j == 4 || i == 5 && j == 6 || i == 5 && j == 9 || i == 6 && j == 3 ||
                            i == 6 && j == 9 || i == 7 && j == 7 || i == 7 && j == 1 || i == 6 && j == 6) {
                        tableroJuego[i][j] = 'A';
                    } else if (i == 1 && j == 5 || i == 1 && j == 6 || i == 3 && j == 6 || i == 3 && j == 9 ||
                            i == 5 && j == 0 || i == 7 && j == 8 || i == 7 && j == 9) {
                        tableroJuego[i][j] = 'L';
                    } else if (i == 1 && j == 8 || i == 5 && j == 1 || i == 5 && j == 1 || i == 6 && j == 4 ||
                            i == 7 && j == 2) {
                        tableroJuego[i][j] = 'T';

                    } else if (i == 0 && j == 4 || i == 2 && j == 8 || i == 5 && j == 8 || i == 2 && j == 4) {
                        tableroJuego[i][j] = 'M';
                    } else if (i == 7 && j == 5) {
                        tableroJuego[i][j] = 'N';
                    } else if (i == 6 && j == 2) {
                        tableroJuego[i][j] = 'H';
                    } else if (i == 3 && j == 4 || i == 5 && j == 5) {
                        tableroJuego[i][j] = 'I';
                    }
